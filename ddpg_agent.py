...
class Agent():
    ...
    def __init__(self, state_size, action_size, num_agents, random_seed,agent_index):
    ...
    def step(self, states, actions, rewards, next_states, dones):
        ...
        if len(Agent.memory) > BATCH_SIZE and self.i_step % LEARN_EVERY == 0:
...
class OUNoise:
    ...
    def reset(self):
        ...
        self.state = copy.copy(self.mu)
        self.sigma = max(SIGMA_MIN,self.sigma*SIGMA_DECAY)
